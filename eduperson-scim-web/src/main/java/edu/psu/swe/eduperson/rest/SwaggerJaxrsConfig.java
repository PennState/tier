...
public class SwaggerJaxrsConfig implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent event) {
    ...
    try {
      ...
      beanConfig.setResourcePackage("edu.psu.swe");
      beanConfig.setScan(true);
      beanConfig.setTitle("EduPerson SCIM Server");
      beanConfig.setDescription("EduPerson SCIM Server Example Implementation");
